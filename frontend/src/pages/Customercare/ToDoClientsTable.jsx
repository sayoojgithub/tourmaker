...
const ToDoClientsTable = ({ onSeeMore,handleSeeTodayPerformance }) => {
  ...
  const fetchClients = async (term = searchTerm, tourStatus= statusFilter) => {
    ...
    try {
      ...
      const status = "Day Ago,End Day,Ongoing,Start Day,Scheduled"; // fetch all initially
      ...
      const response = await fetch(
        `${BASE_URL}/customercare/todo-clients?${queryParams}`
      );
  ...
  <div className="flex items-center gap-3 bg-white/30 px-4 py-1 rounded-lg shadow">
    ...
    {/* Performance Icon */}
    <svg
    onClick={handleSeeTodayPerformance}
...
>
  <path
    ...
    strokeWidth={2}
    d="M8 21h8m-4-4v4m5-16h2a2 2 0 012 2v1a5 5 0 01-5 5h-1M5 5H3a2 2 0 00-2 2v1a5 5 0 005 5h1m0-8v6a4 4 0 004 4h0a4 4 0 004-4V5"
  />
</svg>
  </div>
</div>
...
export default ToDoClientsTable;
