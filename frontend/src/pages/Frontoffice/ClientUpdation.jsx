...
const ClientUpdation = ({ clientId }) => {
  ...
  const [mobileNumberForSearch, setMobileNumberForSearch] = useState("");
  ...
  const handleDestinationChangeForSearch = (selected) => {
    setSelectedDestinationsForSearch(selected);
  };
  ...
  const handleSearchForUpdate = async (id) => {
    ...
    try {
      ...
      const response = await fetch(`${BASE_URL}/frontoffice/fetchClient/${id}`, {
        method: "GET",
        headers: {
  ...
  useEffect(() => {
    if (clientId) {
      handleSearchForUpdate(clientId);
    }
  }, [clientId]);
  ...
  const handleUpdateClient = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${BASE_URL}/frontoffice/updateClient/${clientId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="w-full  p-4 bg-white/20 backdrop-blur-md rounded-xl border border-white/30 shadow-lg mt-1">
      ...
      {/* Main Form */}
      <form className="grid grid-cols-4 gap-2 p-2 bg-white/20 rounded-lg shadow-lg">
        {/* Row 1 */}
        <input
          type="text"
          placeholder="Name"
          ...
          className="bg-gray-100 border border-gray-300 rounded-lg p-3 h-12 shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-300"
        />
        <input
          type="text"
    ...
    />
        ...
        <textarea
          ...
          className="bg-gray-100 border border-gray-300 rounded-lg p-3 h-10 shadow-md  focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-300 col-span-4 text-center"
        />
        ...
        <div className="col-span-4 flex justify-center mt-1">
          ...
          <button
            ...
            className="bg-blue-600 text-white w-full font-semibold py-2 px-4 rounded-lg shadow-lg hover:bg-blue-600 transition duration-300"
