...
//         page: page.toString(),
//         limit: "10",                 // tweak page size if you want
//         search: term.trim(),         // search by name or mobile number
...
//             ) : (
//               <tr>
//                 <td colSpan="5" className="text-center p-4 font-extrabold text-red-600">
//                   No clients found
//                 </td>
//               </tr>
//             )}
