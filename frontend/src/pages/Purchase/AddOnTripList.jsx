      ...
      try {
        ...
        if (user && user._id) {
          ...
          const response = await fetch(
            `${BASE_URL}/purchaser/addOnTrips?purchaserId=${purchaserId}&page=${currentPage}&limit=4&search=${searchQuery}`
          );
    ...
    <h2 className="text-xl font-bold text-red-600 text-center">
      ...
      <div className="flex mb-4">
        <input
          ...
          placeholder="Search by trip name or destination name or Add-OnTrip name..."
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr>
            ...
            <th className="border px-8 py-1 font-extrabold">Add-On Trip Name</th>
        ...
        <tbody>
          {trips.map((trip) => (
            <tr key={trip._id}>
              ...
              <td className="border px-8 py-1 font-bold text-center">{trip.addOnTripName}</td>
